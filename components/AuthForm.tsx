                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                            {type === 'sign-up' && (
                                <>
                                    ...
                                    <div className='flex gap-4'>
                                        <CustomInput control={form.control} label='State' name='state' placeholder='Example: MH' />
                                        <CustomInput control={form.control} label='Postal Code' name='postalCode' placeholder='111111' />
                                    </div>
                                    <div className='flex gap-4'>
